...
describe('Analytics API Integration Tests', () => {
  ...
  describe('GET /api/analytics/network-types', () => {
    it('should return 200 and network type distribution', async () => {
      ...
      const res = await request(app).get('/api/analytics/network-types');
  ...
  describe('GET /api/analytics/signal-strength', () => {
    it('should return 200 and signal strength distribution', async () => {
      ...
      const res = await request(app).get('/api/analytics/signal-strength');
  ...
  describe('GET /api/analytics/temporal-activity', () => {
    it('should return 200 and temporal activity', async () => {
      ...
      const res = await request(app).get('/api/analytics/temporal-activity');
  ...
  describe('GET /api/analytics/radio-type-over-time', () => {
    it('should return 200 and radio type over time', async () => {
      ...
      const res = await request(app).get('/api/analytics/radio-type-over-time?range=7d');
    ...
    it('should return 400 for invalid range', async () => {
      const res = await request(app).get('/api/analytics/radio-type-over-time?range=invalid');
  ...
  describe('GET /api/analytics/security', () => {
    it('should return 200 and security distribution', async () => {
      ...
      const res = await request(app).get('/api/analytics/security');
  ...
  describe('GET /api/analytics/top-networks', () => {
    it('should return 200 and top networks', async () => {
      ...
      const res = await request(app).get('/api/analytics/top-networks?limit=10');
  ...
  describe('GET /api/analytics/bulk', () => {
    it('should return 200 and bulk data', async () => {
      ...
      const res = await request(app).get('/api/analytics/bulk');
  ...
  describe('GET /api/analytics/threat-distribution', () => {
    it('should return 200 and threat distribution', async () => {
      ...
      const res = await request(app).get('/api/analytics/threat-distribution');
  ...
  describe('GET /api/analytics/threat-trends', () => {
    it('should return 200 and threat trends', async () => {
      ...
      const res = await request(app).get('/api/analytics/threat-trends?range=30d');
