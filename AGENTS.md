...
- Frontend lives in `client/` (React/Vite entry `client/src/main.tsx`, routing in `client/src/App.tsx`); legacy HTML stays in `client/public/` until parity—do not delete.
