-- Migration: 20260530_023_ubiquiti_unifi_vap_sibling_rule.sql
-- Add Ubiquiti UniFi VAP sibling rule to automatically resolve virtual APs and cross-band
-- same-chassis radios (OUI xx:E2:C6) without relying on distance or geocoding.
...
SELECT
  ...
  END AS confidence,
  CASE
    WHEN assigned_bucket IN ('Class A', 'Unnamed Recursive (Class A)', 'Ubiquiti UniFi VAP (Class A)') THEN 'o2-o5'::text
