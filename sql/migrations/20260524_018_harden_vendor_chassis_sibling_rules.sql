-- Migration: 20260524_018_harden_vendor_chassis_sibling_rules.sql
-- Harden vendor-specific chassis sibling rules:
-- Mist, AirLink, and Sierra Wireless should not be allowed through the generic position-independent 5-of-6 Class B fallback
-- when the mismatch is in octets 1-5. They must require octets_1_5_identical.
...
classified AS (
  SELECT
    ...
    octet_4_delta,
    CASE
      WHEN (is_known_cradlepoint OR has_la_bit) AND octets_2_5_identical THEN
      ...
      WHEN matched_octets_count >= 5 AND octet_6_delta <= 7
        AND NOT (
          (oui_target IN ('70:90:41', '7C:B6:8D', 'A8:3A:79', 'A8:53:7D', 'A8:F7:D9', 'AC:23:16', 'C8:78:67', 'D4:20:B0', 'D4:DC:09', '1C:28:AF', '00:14:3E', '28:A3:31')
           OR oui_sibling IN ('70:90:41', '7C:B6:8D', 'A8:3A:79', 'A8:53:7D', 'A8:F7:D9', 'AC:23:16', 'C8:78:67', 'D4:20:B0', 'D4:DC:09', '1C:28:AF', '00:14:3E', '28:A3:31'))
