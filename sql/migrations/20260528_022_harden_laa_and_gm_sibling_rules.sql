-- Migration: 20260528_022_harden_laa_and_gm_sibling_rules.sql
-- Harden sibling detection rules to eliminate false-positive pairings in:
-- 1. Locally Administered Address (LAA) randomized/private BSSID Class B bridges
-- 2. GM/LG Innotek vehicle hotspots (OUI 02:92:A5 / 00:92:A5) across different vehicles
--
-- Preserves valid same-chassis LAA pairings (Class A) and valid same-vehicle GM hotspots.
