-- Migration: 20260509_006_fix_ssid_exact_sequential_final.sql
-- Final fix for ssid_exact_sequential rule:
-- 1. Enforce o1-o5 identical (no cross-OUI pairs)
-- 2. Return 'o1-o5+ssid' as matched_octets unconditionally
-- 3. Add msamobile, pasrig, masimo to fleet exclusion list
-- 4. Add hmc% and sas% prefix exclusions

SET search_path TO app, public;

-- Drop existing function if it exists (return type change requires drop)
