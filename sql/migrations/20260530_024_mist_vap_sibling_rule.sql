-- Migration: 20260530_024_mist_vap_sibling_rule.sql
-- Add Mist Systems VAP sibling rule to automatically resolve same-chassis virtual APs
-- (OUI D4:20:B0 / D4:DC:09) with last-octet delta <= 18 without relying on distance or geocoding.
...
SELECT
  ...
  END AS confidence,
  CASE
    WHEN assigned_bucket IN ('Class A', 'Unnamed Recursive (Class A)', 'Ubiquiti UniFi VAP (Class A)', 'Mist Systems VAP (Class A)') THEN 'o2-o5'::text
