-- Migration: 20260524_019_harden_cisco_chassis_sibling_rules.sql
-- Harden Cisco Systems enterprise chassis sibling matching rules against same-index/different-chassis over-linking.
-- Cisco enterprise OUIs (24:D7:9C and 5C:5B:35) are added to the protected-vendor guard
-- so that generic Class B fallback requires octets_1_5_identical.
