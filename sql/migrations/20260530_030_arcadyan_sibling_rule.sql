-- Migration: 20260530_030_arcadyan_sibling_rule.sql
-- Add Arcadyan HOME-EE7D sibling rule for xx:B0:66:EB:E1 BSSID families
-- to automatically resolve virtual APs on different bands where bytes 2-5 match exactly
-- and the final octet delta is <= 7.
