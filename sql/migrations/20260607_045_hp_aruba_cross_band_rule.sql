-- Migration: 20260607_045_hp_aruba_cross_band_rule.sql
-- Add HP Aruba cross-band sibling rule for dual-radio APs sharing a five-octet base
-- and SSID slot index, with the final-octet high nibble incrementing by band.
