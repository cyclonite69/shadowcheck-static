-- ============================================================================
-- SIBLING DETECTION OPTIMIZED V3 (2026-03-28)
-- ============================================================================
-- 1. Incremental Refresh (only processes recently changed networks)
-- 2. Penalizes empty SSIDs
-- 3. Penalizes "Common SSIDs" at distance
-- 4. Robust NULL handling for BSSID parts
-- ============================================================================
