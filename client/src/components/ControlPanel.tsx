...
export const ControlPanel: React.FC<ControlPanelProps> = ({ isOpen, className = '', children }) => {
  ...
  return (
    <div
      className={`fixed top-16 right-4 w-80 max-h-[calc(100vh-100px)] bg-slate-900/95 border border-blue-500/25 backdrop-blur-xl rounded-xl shadow-2xl p-5 space-y-3.5 text-sm overflow-y-auto z-40 pointer-events-auto ${className}`}
    >
