...
export const KeplerFilterPanel: React.FC<KeplerFilterPanelProps> = ({ isOpen, adaptedFilters }) => {
  ...
  return (
    <div
      className="fixed top-16 left-[352px] w-72 max-h-[calc(100vh-80px)] bg-slate-900/95 border border-slate-600/60 backdrop-blur-xl rounded-xl shadow-2xl overflow-hidden z-40 pointer-events-auto"
