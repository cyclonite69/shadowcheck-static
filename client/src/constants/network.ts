...
> & { select: { label: string; width: number; sortable: boolean; default: boolean } } = {
  ...
  threat_rule_score: { label: 'Rule Score', width: 90, sortable: false, default: false },
  threat_ml_score: { label: 'ML Score', width: 90, sortable: false, default: false },
  threat_ml_weight: { label: 'ML Weight', width: 90, sortable: false, default: false },
  threat_ml_boost: { label: 'ML Boost', width: 90, sortable: false, default: false },
