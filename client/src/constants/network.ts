...
export const NETWORK_COLUMNS: Partial<Record<keyof NetworkRow | 'select', NetworkColumnConfig>> & {
  ...
  threat_score: { label: 'Threat Score', width: 100, sortable: true, default: true },
  threat_rule_score: { label: 'Rule Score', width: 90, sortable: true, default: false },
  threat_ml_score: { label: 'ML Score', width: 90, sortable: true, default: false },
  threat_ml_weight: { label: 'ML Weight', width: 90, sortable: true, default: true },
  threat_ml_boost: { label: 'ML Boost', width: 90, sortable: true, default: false },
  ...
  geocoded_city: { label: 'Geocoded City', width: 140, sortable: true, default: false },
  geocoded_state: { label: 'Geocoded State', width: 110, sortable: true, default: false },
  ...
  geocoded_country: {
    label: 'Geocoded Country',
    width: 130,
    sortable: true,
    default: false,
  },
  geocoded_poi_name: { label: 'POI Name', width: 180, sortable: true, default: false },
  geocoded_poi_category: {
    label: 'POI Category',
    width: 140,
    sortable: true,
    default: false,
  },
  geocoded_feature_type: {
    label: 'Feature Type',
    width: 120,
    sortable: true,
    default: false,
...
export const API_SORT_MAP: Partial<Record<keyof NetworkRow, string>> = {
  ...
  threat_rule_score: 'threat_rule_score',
  threat_ml_score: 'threat_ml_score',
  threat_ml_weight: 'threat_ml_weight',
  threat_ml_boost: 'threat_ml_boost',
  ...
  geocoded_postal_code: 'geocoded_postal_code',
  geocoded_country: 'geocoded_country',
  geocoded_poi_name: 'geocoded_poi_name',
  geocoded_poi_category: 'geocoded_poi_category',
  geocoded_feature_type: 'geocoded_feature_type',
  geocoded_provider: 'geocoded_provider',
