...
mkdir -p server/src/services server/src/repositories server/src/api/routes/v1
...
echo "    const { router: dashboardRouter, initDashboardRoutes } = require('./server/src/api/routes/v1/dashboard');"
