...
- Frontend: `client/src/components/`, `client/src/App.tsx`, `client/src/main.tsx`, styles in `client/src/index.css` (legacy HTML assets archived in `docs/archive/legacy-html/public/`).
