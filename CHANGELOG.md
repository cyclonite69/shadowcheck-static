...
- **admin:** 4-category status display in API Testing Tab ([fec1b2c](https://github.com/cyclonite69/shadowcheck-web/commit/fec1b2c3ddc70d6f523e21f0f98d53f6d98631de))
...
- **admin:** prevent import-sqlite crash from missing ETL command ([cd49059](https://github.com/cyclonite69/shadowcheck-web/commit/cd4905972c299026bf0dd2c2b5d1fb8943bbdf97))
...
- **admin:** qualify duplicate index stats query ([88de456](https://github.com/cyclonite69/shadowcheck-web/commit/88de456f22ec1a93a37a6a34c21f5289e0b2c3b7))
...
- **api:** normalize observations endpoint timestamp type to float8 ([4a19bcc](https://github.com/cyclonite69/shadowcheck-web/commit/4a19bcc67251fec4c0729c3d6417c6493469068a))
...
- **auth:** prevent repeated 401 redirect loading loop ([1fed83c](https://github.com/cyclonite69/shadowcheck-web/commit/1fed83c6bf931f7a36c5bde8b0075d14d1d932f2))
...
- **auth:** redirect to login on 401 response instead of blank screen ([5b608a9](https://github.com/cyclonite69/shadowcheck-web/commit/5b608a94c387d211f89ce634df4d1ab98b30b4df))
...
- **automation:** sibling job timeout guard and save config error ([1f770b1](https://github.com/cyclonite69/shadowcheck-web/commit/1f770b1e31fe250020bd29f7fb0ad854b473ec60))
...
- correct 3 backend bugs found by API endpoint testing ([a4e3f63](https://github.com/cyclonite69/shadowcheck-web/commit/a4e3f6355b14305276a96b9e246176e47d380113))
...
- **date:** replace raw date formatting with formatShortDate/formatISODate standard ([0e3323d](https://github.com/cyclonite69/shadowcheck-web/commit/0e3323dcd768d0a944116dba3e85f6587ec4e19f))
...
- **deploy:** harden scs_rebuild — rollback tags, swap warning, deduplicate migrations ([4e24cc9](https://github.com/cyclonite69/shadowcheck-web/commit/4e24cc988f06f5bf4036dbfe60a965fecebb9a02))
...
- exclude /vendor-docs from SPA fallback ([bd1d9a7](https://github.com/cyclonite69/shadowcheck-web/commit/bd1d9a7e6d6a34cb4c8bd5bac211e62c9b519275))
...
- **filter:** add surveillance predicate to fast path ([eec9e2d](https://github.com/cyclonite69/shadowcheck-web/commit/eec9e2d3385eaea7f9ab9068b58433c899bc3677))
...
- **forensic:** enforce true read-only execution in sibling audit tooling ([b7f7c14](https://github.com/cyclonite69/shadowcheck-web/commit/b7f7c14cd8d4fc522d1d34f2a94d595fa18220d8))
...
- **geospatial:** add tag, x, y coordinates to context menu layout dependencies ([52e351f](https://github.com/cyclonite69/shadowcheck-web/commit/52e351fd66beff8c5dadc7ac265fb788e8a55498))
...
- **geospatial:** clarify media overlay behavior ([d08293b](https://github.com/cyclonite69/shadowcheck-web/commit/d08293bd051428be97831aba9006596e45331f5d))
...
- **geospatial:** log non-renderable sibling refs offscreen ([90ddbc2](https://github.com/cyclonite69/shadowcheck-web/commit/90ddbc2ce8489a56c8455a851f807e6de0bbf6ee))
...
- **geospatial:** preserve scroll during sibling hydration ([8fbd7db](https://github.com/cyclonite69/shadowcheck-web/commit/8fbd7db708844e5c8dd3710bb59a0d9c9d2403bf))
...
- **geospatial:** propagate session expiry to auth flow ([127f0d5](https://github.com/cyclonite69/shadowcheck-web/commit/127f0d54314a0f5963938d0172d275541f9a50e8))
...
- **geospatial:** stabilize sibling topology and surface hydration gaps ([b9e52d9](https://github.com/cyclonite69/shadowcheck-web/commit/b9e52d92b1039ae1b5171d457d9db51bb7c067dc))
...
- **geospatial:** unify nearest-place cluster panel ([2bb678e](https://github.com/cyclonite69/shadowcheck-web/commit/2bb678ebce6c7bd12e1cb2058b5aea4685bdea67))
...
- **import-runs:** filter phantom enrichment rows, add delete, strip state from target cell ([1b7b8e8](https://github.com/cyclonite69/shadowcheck-web/commit/1b7b8e8a057deeb4e1676a2ad99e87c0625972f7))
...
- **media:** prefer exact observation coordinates for matched pins ([1609937](https://github.com/cyclonite69/shadowcheck-web/commit/16099375e92f3aa03d491273a2c8327b8016e8ea))
...
- networks explorer scroll position jumps to top on pagination ([1e4e78f](https://github.com/cyclonite69/shadowcheck-web/commit/1e4e78f8b94bc4ed56b65b5f68c2dd7ecbdd3ac9))
...
- overhaul find_sibling_radios — WiFi-only, fix randomized MAC FPs, confidence cap, evidence cols ([7f843f9](https://github.com/cyclonite69/shadowcheck-web/commit/7f843f9d31bac4aad434d7c5d23b92221de7b56d))
...
- rate limiter admin bypass never worked, raise ceiling to 50k ([20b42ed](https://github.com/cyclonite69/shadowcheck-web/commit/20b42ed5fa64077585cc016ceed870f915f9007a))
...
- relax locally-administered MAC filter for middle_octets_sequential ([ebac885](https://github.com/cyclonite69/shadowcheck-web/commit/ebac885cdb4ed02a1b90b7b60b0505e3a1014fcc))
...
- remove visibility filter on sibling group formation ([bad7694](https://github.com/cyclonite69/shadowcheck-web/commit/bad7694badcf18986abd4342ea00f9725bd8014d))
...
- **server:** replace override dotenv with canonical loadEnv to preserve container env vars ([f503c3c](https://github.com/cyclonite69/shadowcheck-web/commit/f503c3c74cb57306d6de8c09ad040839e5458d99))
...
- sibling detection batchSize mapping, cancel endpoint, cancel UI button ([bbf7678](https://github.com/cyclonite69/shadowcheck-web/commit/bbf7678e9898628c96c1bb0603b77ae2ef373051))
...
- **siblings:** harden LAA Class A fallback delta ([805b634](https://github.com/cyclonite69/shadowcheck-web/commit/805b6348e462af99acd37827336f8d228e508266))
...
- **siblings:** tighten ssid_anchor to 4-octet match ([1a94207](https://github.com/cyclonite69/shadowcheck-web/commit/1a94207ddc2fbe89dc23f7df92196bfd326a089a))
- **siblings:** tune Cradlepoint fleet sibling parity ([249b108](https://github.com/cyclonite69/shadowcheck-web/commit/249b108a9ecb73a6f6d2c7476dd80b1edf1a333f))
...
- skip octet_delta_max rename if run_max_octet_delta already exists ([aee16e2](https://github.com/cyclonite69/shadowcheck-web/commit/aee16e21394993e495f87b78e9a253a681bd2baa))
...
- split EXTRA_RULES_SQL into separate statements to fix double-row crash ([cdd75ab](https://github.com/cyclonite69/shadowcheck-web/commit/cdd75ab45beee2333c8b02721adfeb94f27403e9))
...
- ssid_exact_sequential final fix — enforce o1-o5, expand fleet exclusions ([06fef5a](https://github.com/cyclonite69/shadowcheck-web/commit/06fef5a02de152f56b18beb8836b1ce07a7dfc74))
...
- **surveillance:** exclude WiFi networks from Flock detection and revert Explorer COALESCE ([fbe6a85](https://github.com/cyclonite69/shadowcheck-web/commit/fbe6a85605d6cea6398a6a7d2d227ed5312d3825))
...
- **tests:** fix 2 failing unit test suites ([977ddbd](https://github.com/cyclonite69/shadowcheck-web/commit/977ddbdf9f75bce99a761bee4f62c47295673572))
...
- **tests:** repair 4 pre-existing broken test suites ([45459c9](https://github.com/cyclonite69/shadowcheck-web/commit/45459c91dca3304bcb631bba66f5036418731983))
...
- **tooltip:** remove duplicate tophat from renderNetworkTooltip ([26160e8](https://github.com/cyclonite69/shadowcheck-web/commit/26160e81a2505c15d1ecce71c434ba44e61b68d1))
...
- **tooltip:** restore original WiGLE tophat badge (amber/green translucent band) ([f69db66](https://github.com/cyclonite69/shadowcheck-web/commit/f69db6620b8f5d0de34810f2f3105439c4e0928b)), closes [#f59e0b](https://github.com/cyclonite69/shadowcheck-web/issues/f59e0b) [#22c55e](https://github.com/cyclonite69/shadowcheck-web/issues/22c55e)
...
- **types:** add missing createCirclePolygon import and device_type field ([a5ee86b](https://github.com/cyclonite69/shadowcheck-web/commit/a5ee86b5e947b5382012f73e1b34b731b89d78d4))
...
- **wigle:** align coverage grid territory handling ([ae62b8f](https://github.com/cyclonite69/shadowcheck-web/commit/ae62b8f41f2f6b771b4f527a5b42e5a3c1c8c8cf))
...
- **wigle:** correct detail lookup timestamps and observed SSID ([6f84c5b](https://github.com/cyclonite69/shadowcheck-web/commit/6f84c5bd27c60ac2055f38cf9ae797c78dd82ade))
...
- **wigle:** implement case-insensitive term deduplication and 56-state skeleton coverage checklist ([17d898b](https://github.com/cyclonite69/shadowcheck-web/commit/17d898b257225b3aecdea51b072dd905e7853807))
...
- **wigle:** map observed_at to lasttime and wigle_v3_last_seen for v3 rows ([cf63a10](https://github.com/cyclonite69/shadowcheck-web/commit/cf63a105f1c9f5c14d0e1e07c975ac0389a69771))
...
- **wigle:** surface ledger coverage without auto probes ([17284d3](https://github.com/cyclonite69/shadowcheck-web/commit/17284d31da8fc590f9e4ecaec5dc893d26909a93))
...
- **wigle:** use v3 temporal fields as primary source for v3 rows in GeoJSON ([b9aa32a](https://github.com/cyclonite69/shadowcheck-web/commit/b9aa32a25c6558075f6703c62b5e28217fa41b0a))
...
- **admin:** add optional authenticated testing mode to API Testing Tab ([7c33813](https://github.com/cyclonite69/shadowcheck-web/commit/7c33813daae3ec7768e24c19f5d9afb5b69fae12))
...
- **badge-studio:** add per-column editor and explorer rendering ([832951c](https://github.com/cyclonite69/shadowcheck-web/commit/832951c3ed320ebbce8768c834c773dbca614559))
- **badge-studio:** add runtime feature toggle ([a131dcb](https://github.com/cyclonite69/shadowcheck-web/commit/a131dcb777d51241d36b96eb051105d2dabd3818))
...
- implement targeted and manufacturer high-value backfill sweeps ([cd8f6a8](https://github.com/cyclonite69/shadowcheck-web/commit/cd8f6a81e74c36dfe6bd050ead32d00021a00fdc)), closes [hi#value](https://github.com/hi/issues/value)
...
- **kml:** sync WiGLE KML transactions via official API ([6ecaa6e](https://github.com/cyclonite69/shadowcheck-web/commit/6ecaa6e0f450f1903dda9018431614f83f82164a))
...
- **sibling:** add HP Aruba cross-band rule to find_sibling_radios ([11e2e6c](https://github.com/cyclonite69/shadowcheck-web/commit/11e2e6c32d7a4a4e1f1bf7d76f8016208ab6f019))
- **sibling:** add Mist Systems cross-band rule to find_sibling_radios ([ecb0716](https://github.com/cyclonite69/shadowcheck-web/commit/ecb0716bdf6a4da2ae87af3a97b80bfa7055cc39))
- **sibling:** add mv_sibling_groups materialized view with TC and refresh wiring ([d15bb1a](https://github.com/cyclonite69/shadowcheck-web/commit/d15bb1a7c235bc378d54207f2a38075d7e945a62))
- **sibling:** replace broad GM rule with six validated Qualcomm LAA patterns ([667a9d0](https://github.com/cyclonite69/shadowcheck-web/commit/667a9d010aca769a2dcd46b7f3b90bef0728f17a))
...
- **siblings:** consolidate deterministic vendor twin rules ([67ba187](https://github.com/cyclonite69/shadowcheck-web/commit/67ba1878fc1b0f990b3a9b06202a3ae3ad0dae09))
...
- **surveillance:** add dry-run mode to surveillance scan job ([d1811ed](https://github.com/cyclonite69/shadowcheck-web/commit/d1811ede0dec253b2c90cd17d56af42ea78a5426))
...
- **surveillance:** body cam detection tiers 13-18, sibling pipeline overhaul, BLE MV fix ([4915a78](https://github.com/cyclonite69/shadowcheck-web/commit/4915a78b9f81e6471fb823c661c14c0806e05db8))
...
- **surveillance:** multi-factor confidence scoring pipeline ([559c5d3](https://github.com/cyclonite69/shadowcheck-web/commit/559c5d38e7aa442b6ac2559944e61bca291b7120))
...
- **wigle:** add Home Area overlay toggle ([320f598](https://github.com/cyclonite69/shadowcheck-web/commit/320f59805bb2533b986e9e3a742a1c418225bdc9))
...
- **wigle:** cached user-stats on rate-limit, api endpoint alignment, metrics update ([cd81b9f](https://github.com/cyclonite69/shadowcheck-web/commit/cd81b9f48de5eb2834a58b38d05275b60eea608e))
...
- **geospatial:** fix component endpoint called for every visible row ([37d9d2b](https://github.com/cyclonite69/shadowcheck-web/commit/37d9d2b943e7964bda2652bdebc4cb8012e77018))
