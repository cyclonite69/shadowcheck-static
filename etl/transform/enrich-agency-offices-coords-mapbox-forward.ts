...
function parseArgs(argv: string[]): Options {
  ...
  // If we use a dedicated/unlimited key, it's generally safer to request permanent=true.
  // (Still subject to your Mapbox terms.)
...
async function main(): Promise<void> {
  ...
  // Prefer the unlimited key if present.
  const mapboxToken =
