...
const SETTINGS_SQL = `SELECT key, value FROM app.settings WHERE key IN ('backup_job_config', 'ml_scoring_job_config', 'mv_refresh_job_config', 'sibling_detection_job_config', 'surveillance_scan_job_config')`;
