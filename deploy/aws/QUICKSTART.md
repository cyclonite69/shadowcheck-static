...
- Username: `admin`
- Password: `shadowcheck/config: admin_app_password`

**⚠️ Run `./deploy/aws/scripts/init-admin-user.sh` to create/reset admin user and sync `admin_app_password` to AWS Secrets Manager**  
